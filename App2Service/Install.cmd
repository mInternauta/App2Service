...
%INSTALL_UTIL_EXE% /name=App2Service /account=%1 %SERVICE_EXE%
...
echo.
echo To install App2Service you must supply an account type that is used to start 
echo App2Service as parameter:
...
echo.
echo The file installutil.exe (part of the .Net  runtime) could not be found.
